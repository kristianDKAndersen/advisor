 ...
 *
 * --print is intentional here: preflight is a 5s classifier (not a long-running worker)
 * and relies on --output-format json's stdout envelope, which is incompatible with the
 * tmux+Stop-hook pattern used by spawnHeadless. See migration-plan.md §6 "Cannot Preserve".
 *
