...
function provisionOne(args, overrideSid) {
  ...
  const claudeCore = `claude --permission-mode auto ${modelFlag}${allowedToolsFlag}--strict-mcp-config -- "$(cat ${shesc(promptFile)})"`;
...
module.exports = { composeBootstrapPrompt, trustWorkspaceInClaudeConfig, resolveIntelligence, provisionOne, buildProtectedTestsEnv, buildMcpDenylist };
